...
public class ModMemoryModules {
    ...
    public static final MemoryModuleType<GlobalPos> PERSONAL_HOME = register("personal_home", GlobalPos.CODEC);
    public static final MemoryModuleType<Long> LAST_VISITED_HOME = register("last_visited_home", Codec.LONG);
