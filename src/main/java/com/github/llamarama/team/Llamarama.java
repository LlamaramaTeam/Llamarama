...
public class Llamarama implements ModInitializer {
    ...
    public static final ItemGroup LLAMA_ITEM_GROUP = FabricItemGroupBuilder.create(IDBuilder.of("llamarama_group")).icon(() -> new ItemStack(ModItems.WOOLLY_LLAMA_SPAWN_EGG)).build();
