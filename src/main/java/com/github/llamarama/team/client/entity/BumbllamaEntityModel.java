// Made with Blockbench 3.7.5
	...
	package com.github.llamarama.team.client.entity;
...
public class 	BumbllamaEntityModel extends EntityModel<Entity> {
...
public BumbllamaEntityModel() {
		...
		cube_r6.setTextureOffset(33, 0).addCuboid(0.0F, -6.0F, -2.0F, 0.0F, 6.0F, 3.0F, 0.0F, false);
...
public void render(MatrixStack matrixStack, VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha){
		...
		chest1.render(matrixStack, buffer, packedLight, packedOverlay);
		chest2.render(matrixStack, buffer, packedLight, packedOverlay);
		body.render(matrixStack, buffer, packedLight, packedOverlay);
		leg0.render(matrixStack, buffer, packedLight, packedOverlay);
		leg1.render(matrixStack, buffer, packedLight, packedOverlay);
		leg2.render(matrixStack, buffer, packedLight, packedOverlay);
		leg3.render(matrixStack, buffer, packedLight, packedOverlay);
		flowers1.render(matrixStack, buffer, packedLight, packedOverlay);
		flowers2.render(matrixStack, buffer, packedLight, packedOverlay);
		hive.render(matrixStack, buffer, packedLight, packedOverlay);
		bumblellama.render(matrixStack, buffer, packedLight, packedOverlay);
}
